...
export const sendSignUpEmail = inngest.createFunction(
  ...
  async ({ event, step }) => {
    const userProfile = `
       ...
       - Risk tolerance: ${event.data.riskTolerace}
    ...
    await step.run("send-welcome-email", async () => {
      ...
      const introText =
        ...
        "Thanks for joining with us. Yoy can increase your portfolio and make wealth grow abundantly.";
      // NodeMailer Logic
      const {
        data: { email, name },
      } = event;
...
export const sendDailyNewsSumary = inngest.createFunction(
